...
# Defect(s) Found: the code is removing the person x num times not in a queue
...
while len(players) > 0:
    players.get_next_person()
# Defect(s) Found: The enque process needed to be changed and i manipulated the get_next_person function and saw results.
...
players.get_next_person()
# Defect(s) Found:
    # none or were patched in the process of others